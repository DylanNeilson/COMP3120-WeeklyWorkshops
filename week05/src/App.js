...
const Home = () => {
    ...
    return (
        <p style={styles.p}>Welcome to our Unit App. You have not logged in</p>
    );
};
...
const Units = () => {
    ...
    return <p style={styles.p}>Units</p>;
};
...
const AddUnits = () => {
    ...
    return <p style={styles.p}>Add Units</p>;
};
...
function App() {
    ...
    return (
        <div className="App">
            ...
            {units.map((u) => (
                <Unit key={u.id} id={u.id} code={u.code} title={u.title} />
            ))}
        </div>
    );
}
